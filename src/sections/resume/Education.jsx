    ...
    <div className='bg-[#1e2024] flex flex-col items-start gap-5 rounded-lg p-5'>
      ...
      <div className='w-full bg-[#23272b] p-5 rounded-lg shadow-lg flex flex-col gap-3'>
        <h3 className='text-base lg:text-lg font-bold'>
          ...
          <span className='text-xs lg:text-sm text-gray-400 capitalize'>{t('resume.education.faculty')}</span>
        </h3>
        ...
        <span className='text-xs lg:text-sm text-primaryColor'>{t('resume.education.duration')}</span>
      </div>
    </div>
  )
}
