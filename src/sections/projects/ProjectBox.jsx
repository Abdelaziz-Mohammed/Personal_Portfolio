...
function ProjectBox({ title, status, desc, image, github, demo }) {
  return (
    <div className="w-full max-w-[340px] h-auto px-6 py-8 rounded-lg shadow-shadowOne flex flex-col
      ...
      <div>
        ...
        <div>
          <div className='flex items-center justify-between gap-10 py-4'>
            <h3 className='text-sm font-normal text-primaryColor uppercase'>{title}</h3>
          ...
          <p className='text-xs tracking-wide text-green-500 font-normal -mt-5 mb-3'>
            {status}
          </p>
